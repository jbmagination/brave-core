...
// #include "brave/ui/brave_ads/notification_body_view.h"
...
// NotificationBodyView::NotificationBodyView() {
...
// NotificationBodyView::~NotificationBodyView() = default;

// void NotificationBodyView::SetTitle(const base::string16& text) {
//   DCHECK(title_label_);

//   title_label_->SetText(text);
// }

// void NotificationBodyView::SetTitleElideBehavior(
