...
class PermissionExpirationKey {
 public:
  ...
  // Converts from/to pref key value (shouldn't contain dot chars).
  static PermissionExpirationKey FromPrefKey(const std::string& pref_key);
  std::string ToPrefKey() const;
